  ...
  const workflowSteps1 = [
    {
      ...
      title: "Brief Form",
      description:
        "We discuss and gather information from the client to provide design concepts.",
      stepNumber: 1,
    },
    {
      icon: Monitor,
      ...
      description:
        "We create multiple 3D design concepts according to your brief requirements.",
      stepNumber: 2,
    },
    {
      icon: ThumbsUp,
      ...
      description:
        "We involve our clients throughout the process, take feedback, and optimize the design to create a defining 3D concept for the booth.",
      stepNumber: 3,
    },
  ];
  ...
  const workflowSteps2 = [
    {
      ...
      description:
        "After the final approval of 3D booth design, we start production in our manufacturing unit and take the entire responsibility.",
      stepNumber: 4,
    },
    {
      icon: Wrench,
      ...
      description:
        "Our expert installation team will take care of booth building onsite and post-exhibition dismantling and store it for your future use as needed.",
      stepNumber: 5,
    },
    {
      icon: Search,
      ...
      description:
        "Our Project manager will manage any unforeseen circumstances to create an unparalleled on-site experience.",
      stepNumber: 6,
    },
  ];
  ...
  return (
    <section className="py-8 md:py-10 bg-black relative overflow-hidden">
      ...
      <div className="relative w-[90%] sm:w-[85%] lg:w-[80%] max-w-400 mx-auto">
        <Heading1 text="Our Work Flow"></Heading1>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <p className="text-gray-300 text-sm md:text-base leading-relaxed">
              Being the leader in exhibition stand design & stand builder
              company in Germany, Europe, we start the work only after
              understanding your company's vision and objective. Our goal is to
              provide a remarkable experience throughout the entire process of
