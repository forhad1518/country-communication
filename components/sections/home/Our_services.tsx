...
const servicesData = [
  {
    ...
    description:
      "Custom-designed exhibition booths that captivate and engage your audience",
  ...
  },
  {
    ...
    description:
      "Seamless event planning and logistics management for flawless execution",
  ...
  },
  {
    ...
    description:
      "Innovative interior and exterior design solutions for commercial spaces",
  ...
  },
  {
    ...
    description:
      "Strategic branding and promotional campaigns that drive business growth",
    link: "/services/branding",
    color: "from-accent/20 to-accent/5",
    iconColor: "text-accent",
    iconBg: "bg-accent/10",
    stats: "5000+ Campaigns",
  },
];
      ...
      <Link href={service.link} className="block h-full">
        ...
        >
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            {/* Icon Circle */}
            <div
              className={`relative w-28 h-28 md:w-32 md:h-32 ${service.iconBg} rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}
            >
              <Icon
                className={`w-14 h-14 md:w-16 md:h-16 ${service.iconColor}`}
                strokeWidth={1.5}
              />
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-sm font-semibold">
              <span
                className={`${service.iconColor} group-hover:translate-x-1 transition-transform`}
              >
                Learn More
              </span>
              <ArrowRight
                className={`w-4 h-4 ${service.iconColor} group-hover:translate-x-2 transition-transform`}
              />
            </div>
          </div>
    ...
    <section className="py-8 md:py-10 bg-linear-to-b from-black via-gray-900 to-black overflow-hidden">
      <div className="w-[90%] sm:w-[85%] lg:w-[80%] max-w-400 mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          >
            Comprehensive exhibition and event solutions tailored to your
        ...
        >
          <Link
            href="/services"
            className="inline-flex items-center gap-3 px-8 py-4 bg-linear-to-r from-primary to-primary-hover text-white font-semibold rounded-full shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 group cursor-pointer"
          >
