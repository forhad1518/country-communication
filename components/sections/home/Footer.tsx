...
export default function Footer() {
    return (
        <footer className="mt-12 bg-(--color-primaryColor) text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-start">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-white/90">
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">About Us</li>
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Team</li>
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Careers</li>
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Contact</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-white/90">
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Web Development</li>
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Branding</li>
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Marketing</li>
                              <li className="hover:text-(--color-primaryColor-hover) transition cursor-pointer">Portfolio</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <address className="not-italic text-sm text-white/90">
                            ...
                            <div className="flex gap-3 mt-4">
                                {/* Social icons */}
                                <a aria-label="Twitter" href="#" className="hover:text-(--color-primaryColor-hover)">
                                ...
                                <a aria-label="Facebook" href="#" className="hover:text-(--color-primaryColor-hover)">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a aria-label="LinkedIn" href="#" className="hover:text-(--color-primaryColor-hover)">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
